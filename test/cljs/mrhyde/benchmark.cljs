...
(def atomnum (atom 0))
(defn ^:export thisIsATest []
  (swap! atomnum inc))

(defn ^:export createListObject []
  '(1 2 3 4))

(defn ^:export createVectorObject []
  [1 2 3 4])

(defn ^:export createMapObject []
 {:one 1 :two 2 :three 3 :four 4})

(defn ^:export accessSeqObject [s]
  (second s))

(defn ^:export accessMapObject [m]
  (:two m))
